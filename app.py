...
ZONE_POSITIONS = {
    ...
    'E20->E21 VIA1': [{'top': 607, 'left': 176, 'width': 396, 'height': 27, 'label': 'E20->E21 VIA1'}],
    'E20->E21 VIA2': [{'top': 542, 'left': 177, 'width': 395, 'height': 34, 'label': 'E20->E21 VIA2'}],
    'E20->E22 VIA1': [{'top': 607, 'left': 177, 'width': 665, 'height': 30, 'label': 'E20->E22 VIA1'}],
    'E20->E22 VIA2': [{'top': 541, 'left': 172, 'width': 667, 'height': 29, 'label': 'E20->E22 VIA2'}],
    'E20->E23 VIA1': [{'top': 606, 'left': 178, 'width': 911, 'height': 30, 'label': 'E20->E23 VIA1'}],
    'E20->E23 VIA2': [{'top': 542, 'left': 176, 'width': 911, 'height': 30, 'label': 'E20->E23 VIA2'}],
    'E20->E24 VIA1': [{'top': 607, 'left': 177, 'width': 1213, 'height': 29, 'label': 'E20->E24 VIA1'}],
    'E20->E24 VIA2': [{'top': 544, 'left': 173, 'width': 1221, 'height': 25, 'label': 'E20->E24 VIA2'}],
    'E21->E20 VIA1': [{'top': 606, 'left': 169, 'width': 398, 'height': 30, 'label': 'E21->E20 VIA1'}],
    'E21->E20 VIA2': [{'top': 541, 'left': 171, 'width': 397, 'height': 28, 'label': 'E21->E20 VIA2'}],
    'E21->E22 VIA1': [{'top': 606, 'left': 562, 'width': 280, 'height': 30, 'label': 'E21->E22 VIA1'}],
    'E21->E22 VIA2': [{'top': 541, 'left': 564, 'width': 281, 'height': 28, 'label': 'E21->E22 VIA2'}],
    'E21->E23 VIA1': [{'top': 606, 'left': 562, 'width': 533, 'height': 31, 'label': 'E21->E23 VIA1'}],
    'E21->E23 VIA2': [{'top': 543, 'left': 565, 'width': 522, 'height': 28, 'label': 'E21->E23 VIA2'}],
    'E21->E24 VIA1': [{'top': 607, 'left': 564, 'width': 822, 'height': 29, 'label': 'E21->E24 VIA1'}],
    'E21->E24 VIA2': [{'top': 541, 'left': 565, 'width': 828, 'height': 31, 'label': 'E21->E24 VIA2'}],
    'E22->E20 VIA1': [{'top': 607, 'left': 167, 'width': 665, 'height': 29, 'label': 'E22->E20 VIA1'}],
    'E22->E20 VIA2': [{'top': 542, 'left': 166, 'width': 667, 'height': 26, 'label': 'E22->E20 VIA2'}],
    'E22->E21 VIA1': [{'top': 607, 'left': 562, 'width': 268, 'height': 29, 'label': 'E22->E21 VIA1'}],
    'E22->E21 VIA2': [{'top': 543, 'left': 562, 'width': 272, 'height': 28, 'label': 'E22->E21 VIA2'}],
    'E22->E23 VIA1': [{'top': 609, 'left': 830, 'width': 259, 'height': 27, 'label': 'E22->E23 VIA1'}],
    'E22->E23 VIA2': [{'top': 542, 'left': 829, 'width': 259, 'height': 31, 'label': 'E22->E23 VIA2'}],
    'E22->E24 VIA1': [{'top': 608, 'left': 829, 'width': 558, 'height': 28, 'label': 'E22->E24 VIA1'}],
    'E22->E24 VIA2': [{'top': 541, 'left': 825, 'width': 570, 'height': 31, 'label': 'E22->E24 VIA2'}],
    'E23->E20 VIA1': [{'top': 609, 'left': 161, 'width': 923, 'height': 27, 'label': 'E23->E20 VIA1'}],
    'E23->E20 VIA2': [{'top': 544, 'left': 171, 'width': 912, 'height': 28, 'label': 'E23->E20 VIA2'}],
    'E23->E21 VIA1': [{'top': 609, 'left': 554, 'width': 528, 'height': 28, 'label': 'E23->E21 VIA1'}],
    'E23->E21 VIA2': [{'top': 542, 'left': 555, 'width': 528, 'height': 31, 'label': 'E23->E21 VIA2'}],
    'E23->E22 VIA1': [{'top': 607, 'left': 822, 'width': 260, 'height': 29, 'label': 'E23->E22 VIA1'}],
    'E23->E22 VIA2': [{'top': 542, 'left': 819, 'width': 265, 'height': 27, 'label': 'E23->E22 VIA2'}],
    'E23->E24 VIA1': [{'top': 607, 'left': 1077, 'width': 314, 'height': 28, 'label': 'E23->E24 VIA1'}],
    'E23->E24 VIA2': [{'top': 543, 'left': 1082, 'width': 314, 'height': 30, 'label': 'E23->E24 VIA2'}],
    'E24->E20 VIA1': [{'top': 608, 'left': 161, 'width': 1215, 'height': 30, 'label': 'E24->E20 VIA1'}],
    'E24->E20 VIA2': [{'top': 542, 'left': 169, 'width': 1207, 'height': 30, 'label': 'E24->E20 VIA2'}],
    'E24->E21 VIA1': [{'top': 607, 'left': 555, 'width': 825, 'height': 29, 'label': 'E24->E21 VIA1'}],
